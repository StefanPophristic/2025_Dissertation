...
function make_slides(f) {
  ...
  slides.instructions_1 = slide({
     name : "instructions_1",
     start: function() {
       // Force slide and all content visible (in case layout/CSS hides it)
       $("#instructions_1").show().css({ display: "block", visibility: "visible", opacity: 1 });
       $("#instructions_1").find("*").css({ visibility: "visible", opacity: 1 });
     }
  });
